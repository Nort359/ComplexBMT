<section class="record">
    <div class="container">
        ...
        <div class="row row-margin-top text-center">
            <h2 id="record">Для добавления нового эксперта, пожалуйста, заполните все поля:</h2>
        </div>

        <div class="row row-margin-top text-center">

          <?php if ( !empty( $_SESSION[ 'errors' ][ 'message_error_add_expert' ] ) ) : ?>

            <div class="alert-element">
              <div class="icon error-flash-message"><i class="glyphicon glyphicon-remove"></i></div>
              <div class="text"><span><?= $_SESSION[ 'errors' ][ 'message_error_add_expert' ]; ?></span></div>
            </div>

          <?php elseif ( !empty( $_SESSION[ 'errors' ][ 'message_success_add_expert' ] ) ) : ?>

            <div class="alert-element">
              <div class="icon success-flash-message" ><i class="glyphicon glyphicon-ok"></i></div>
              <div class="text"><span><?= $_SESSION[ 'errors' ][ 'message_success_add_expert' ]; ?></span></div>
            </div>
                        ...
                        <div class="col-md-6 col-md-offset-0 col-xs-10 col-xs-offset-1 element-input">
                            <div class="container-input">
                                ...
                                <input type="text"
                                       ...
                                       name="expert-status"
                                       value="<?php
                                                if ( !empty( $_POST[ 'expert-status' ] ) ) {
                                                  echo @$_POST[ 'expert-status' ];
                                                } else {
                                                  echo 'Эксперт';
                                                }
                                              ?>">
