                    ...
                    <div id="record" class="groups-elements">
                        ...
                        <div class="col-md-6 col-md-offset-0 col-xs-10 col-xs-offset-1 element-input">
                            <div class="container-input">
                                <textarea class="form-control short-description"
                                          ...
                                          rows="5"><?= @$inf_block->short_description; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-md-offset-0 col-xs-10 col-xs-offset-1 element-input">
                            <div class="container-input">
                                <textarea class="form-control short-description"
                                          ...
                                          rows="10"><?= @$inf_block->description; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-md-offset-0 col-xs-10 col-xs-offset-1 element-input">
                            <input type="submit"
                                   ...
                                   id="make-statement"
                                   value="Изменить информационный блок"
                                   name="information-block-change">
                        </div>
